...
- **Backend** (`backend/`): Express + Socket.IO game-state engine (difficulty scaling, stamina, obstacles, combos / brain-rot boost, game over).
...
Then open **http://localhost:5173**, pick a difficulty, hit **Enter the Apocalypse**,
and allow webcam access when prompted.
